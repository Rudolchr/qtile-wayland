...
python_compile() {
	if use wayland; then
		addpredict /usr/lib/python3.8/site-packages/wlroots/__pycache__/
		addpredict /usr/lib/python3.9/site-packages/wlroots/__pycache__/
		addpredict /usr/lib/python3.10/site-packages/wlroots/__pycache__/
		addpredict /usr/lib/python3.11/site-packages/wlroots/__pycache__/
	fi
